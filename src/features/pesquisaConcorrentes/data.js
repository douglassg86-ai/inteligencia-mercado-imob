...
const raw = [
  {
    ...
    estrutura: 'Concreto armado convencional, lajes maciças de 14cm; contrapiso cimentado de 5cm com manta acústica sob dormitórios e estar, para atenuação de ruído de impacto e transmissão aérea (NBR 15575); fachadas e divisões interapartamento em bloco cerâmico com reboco; divisórias internas em drywall.',
    esquadrias: 'Dormitórios em alumínio anodizado ou PVC de correr, com persianas de enrolar integradas de fábrica (manual); living em porta-janela de correr piso-teto em alumínio ou PVC. Entrega "no osso": laje aparente c/ pintura em suítes e living, sem tampos/louças/metais.',
